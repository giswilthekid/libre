...
class ServiceList(models.Model):
	...
	user 					= models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
	basic_packet			= models.ForeignKey(settings.AUTH_BASIC_MODEL, on_delete=models.CASCADE, blank=False, null=True)
	standard_packet			= models.ForeignKey(settings.AUTH_STANDARD_MODEL, on_delete=models.CASCADE, blank=False, null=True)
	premium_packet			= models.ForeignKey(settings.AUTH_PREMIUM_MODEL, on_delete=models.CASCADE, blank=False, null=True)
	rating 					= models.IntegerField(validators=[MaxValueValidator(5), MinValueValidator(0)], null=True)
	feedback				= models.CharField(max_length=2000, null=True)
	timestamp	 			= models.DateTimeField(auto_now_add=True, verbose_name="timestamp")
